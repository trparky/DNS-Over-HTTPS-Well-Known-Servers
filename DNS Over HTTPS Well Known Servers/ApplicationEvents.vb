    ...
    Partial Friend Class MyApplication
        Private Sub MyApplication_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
            If Environment.OSVersion.Version.Build <= 19042 Then
                ...
                MsgBox("This version of Windows 10 is not supported. Currently only versions in the Windows Insider Program are supported." & vbCrLf & vbCrLf & "This program will now close.", MsgBoxStyle.Critical, "DNS Over HTTPS Well Known Servers")
                e.Cancel = True
                Exit Sub
            End If
